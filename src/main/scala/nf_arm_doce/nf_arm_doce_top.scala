...
class axidata(AXI_ADDR_WIDTH : Int = 44, AXI_DATA_WIDTH: Int = 16, AXI_ID_WIDTH: Int = 18, AXI_SIZE_WIDTH: Int = 3) extends Bundle {
  val awaddr = Input(UInt(AXI_ADDR_WIDTH.W))
  val awid = Input(UInt(AXI_ID_WIDTH.W))
  val awlen = Input(UInt(8.W))
  val awsize = Input(UInt(AXI_SIZE_WIDTH.W))
  ...
  val arid = Input(UInt(AXI_ID_WIDTH.W))
  val arlen = Input(UInt(8.W))
  val arsize = Input(UInt(AXI_SIZE_WIDTH.W))
  val arburst = Input(UInt(2.W))
  val arlock = Input(Bool())
  val arvalid = Input(Bool())
  val arready = Output(Bool())

  val wdata = Input(UInt((8*AXI_DATA_WIDTH).W))
  val wstrb = Input(UInt(AXI_DATA_WIDTH.W))
  val wlast = Input(Bool())
  val wvalid = Input(Bool())
  val wready = Output(Bool())

  val rdata = Output(UInt((8*AXI_DATA_WIDTH).W))
  val rid = Output(UInt(AXI_ID_WIDTH.W))
  ...
  val bid = Output(UInt(AXI_ID_WIDTH.W))
